...
public class MainActivity extends Activity {
    ...
    private String[] mStrData = {"苏宁看不下去，全场免费送！", "58同城来凑热闹!", "京东大促,全场5元!", "天猫不服,全场不要钱!", "苏宁看不下去，全场免费送！"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mStrData.length; i++) {
            ...
            textView.setText("我是第" + i + "个textview");
            contentView.setTag(i);
            layout.addView(contentView, tparams);
            contentView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(MainActivity.this,contentView.getTag()+"",Toast.LENGTH_SHORT).show();
                }
            });
        }
